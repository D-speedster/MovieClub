      ...
      <div className="site-footer__inner">
        ...
        <div className="site-footer__top">
          ...
          <Link to="/" className="site-footer__logo">
            <span className="site-footer__logo-text">MOVIE</span>
            <span className="site-footer__logo-accent">CLUB</span>
          </Link>

          {/* Nav links */}
          <nav className="site-footer__nav" aria-label="لینک‌های فوتر">
            {links.map((link) => (
              <Link key={link.path} to={link.path} className="site-footer__nav-link">
                {link.label}
              </Link>
            ))}
          </nav>
