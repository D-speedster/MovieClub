        ...
        const fetch = async () => {
            try {
                ...
                setForm({
                    ...
                    type: d.type || 'movie',
                    year: d.year || '',
                    director: Array.isArray(d.directors) ? d.directors.join(', ') : (d.director || ''),
                    writer: Array.isArray(d.writers) ? d.writers.join(', ') : (d.writer || ''),
                    actors: Array.isArray(d.actors) ? d.actors.join(', ') : (d.actors || ''),
                    countries: Array.isArray(d.countries) ? d.countries.join(', ') : (d.countries || ''),
                    language: Array.isArray(d.languages) ? d.languages[0] || '' : (d.language || ''),
                    genres: d.genres || [],
